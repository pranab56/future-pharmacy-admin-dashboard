...
const PrivacyPolicyPage = () => {
  ...
  const [title] = useState<string>("Privacy Policy");
  ...
  const handleUpdate = async () => {
    if (isContentEmpty(content)) {
      toast.error("Privacy content cannot be empty");
      return;
    }
      ...
      <div className="container mx-auto p-6">
        <Card>
          <CardContent className="flex justify-center items-center h-64">
            ...
            <p className="ml-2">Loading Privacy...</p>
          </CardContent>
        </Card>
      </div>
    );
      ...
      <div className="container mx-auto p-6">
        <Card>
          <CardContent className="flex flex-col justify-center items-center h-64">
            <p className="text-red-500 mb-4">Failed to load Privacy</p>
